...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
   <div
  className="relative select-text lg:w-[50%] w-[90%] mx-auto grid justify-center items-center"
  ref={containerRef}
>
  <div className="mx-auto ">
    ...
    <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base ">
      IT graduate with a Bachelor's degree in Information Technology and 1.5 years of
      internship experience
    </p>
  </div>

  <div ref={ref} className="relative grid justify-center items-center mx-auto pb-20">
    {data.map((item, index) => (
      <div
        key={index}
